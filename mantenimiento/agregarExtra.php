<?php
   ...
   if(!empty($_POST)){
    ...
    if(empty($_POST['nombre']) OR empty($_POST['precio']) OR $_POST['materia']=='ESCOGA...'){
      echo '<script>
    ...
    $cod = mysqli_query ($conexion,$consult_materia);
    $cod1= mysqli_fetch_array ($cod);
    $cod_materia=$cod1[0]; 
    
          //Insert
          $insert=mysqli_query($conexion,"INSERT INTO tbl_extra (Nombre, CodigoMateria, Precio) VALUES ('$nombre', '$cod_materia','$precio')");
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <form  action="" method="POST">
                    ...
                    <input  OnKeyUp="this.value=this.value.toUpperCase();" onkeypress="comprobarEspacios(); return sololetras(event);" id="nombre" name='nombre' type="text" class="form-control" placeholder="INGRESE LA DESCRIPCION" >
                  </div>
                  <div class="form-group">
                  <div class="row">
                  <div class="col-lg-6">
                  ...
                  <input  onkeypress="return solonumeros(event);" id="precio" name='precio' type="text" class="form-control" placeholder="INGRESE EL PRECIO" >
                  </div>
