<?php
   ...
   if(!empty($_POST)){
    ...
    if($nombre==''){
      ...
      //Validar si existe 
      $consulta = "SELECT * FROM tbl_mesas WHERE Nombre ='$nombre'" ;
     ...
     $insert=mysqli_query($conexion,"INSERT INTO tbl_mesas (Nombre, CodigoEstado) VALUES ('$nombre',1)");
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <form  action="" method="POST">
                    ...
                    <input value='' OnKeyUp="this.value=this.value.toUpperCase();" onkeypress="comprobarEspacios(); return sololetras(event);" id="nombre" name='nombre' type="text" class="form-control" placeholder="INGRESE EL NUMERO O NOMBRE" >
                  </div>
                  <div class="form-group">
                  <div class="row">
                  <div class="col-lg-6">
