<?php
 ...
 /*BITACORA*/
 $consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'eliminarMesa.php'";
 ...
 $CodObjeto=$numero;
 $accion='Ingreso';
 $descrip='Ingreso en la pantalla de listado de estados de pedidos';
   ...
   $descrip1=$variable['Nombre'];

   if(isset($_POST['Aceptar'])) {
    if ('Aceptar'){
      
    $consulta="DELETE FROM tbl_mesas WHERE CodigoMesa= $cod";
...
<div class="register-box">
  ...
  <div class="card-header text-center">
     <strong>¿Desea eliminar la Mesa<?php echo " '".$descrip1."'"?> ?</strong>
    </div>
...
<?php } ?>
          ...
          <div class="mb-2 col-6 text-center ">
            <a href="mesas.php" class="btn btn-success"><i class =""></i>NO</a>
          </div>
          <!-- /.col -->
        </div>
