...
include 'funcionBitacora.php';
  ...
  if(isset($_POST['Aceptar'])) {
    ...
    window.location="../mantenimiento/mantenimiento_tipo_catalogo_eventos.php";
      ...
      $query = "DELETE FROM tbl_tipocatalogoevento WHERE CodigoTipoCatalogo =$codigo";
  ...
  if (isset($_GET['CodigoTipoCatalogo'])) {
    ...
    //BITACORA/
$consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'mantenimiento_tipo_catalogo_eventos_borrar.php'";
  ...
  <section id="content-header">
    ...
    <div class="card card-danger">
                <div class="card-header">
                  <h3 class="card-title">¿Está seguro de eliminar <?php echo $fila['Descripcion']; ?>?</h3>
                </div>
               <!-- /.card-header -->
                <!-- form start -->
                ...
                <div class="card-body">
                <div class="card-body">
                    <p>Descripción:<span> <?php echo $fila['Descripcion']; ?></span></p>
                    </div>
                    </div>
                  <!-- /.card-body -->
                  <div class="row mb-2">
