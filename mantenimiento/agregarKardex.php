<?php
   ...
   session_start();
        ...
        $consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'agregarKardex.php'";
        ...
        $CodObjeto=$numero;
        $accion='Agregar';
        $descrip='Se agrego un tipo de kardex';
   ...
   if(!empty($_POST)){
    ...
    if($descrip==''){
     ...
     $insert=mysqli_query($conexion,"INSERT INTO tbl_tipokardex (Descripcion) VALUES ('$descrip')");
     ...
     if($insert){
        ...
        window.location="tipokardex.php";
        </script>';
     }
    }
          ...
          <div class="col-md-5">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Agregue un tipo de kardex</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <form  action="" method="POST">
                    ...
                    <input value='' OnKeyUp="this.value=this.value.toUpperCase();" onkeypress="comprobarEspacios(); return sololetras(event);" id="descripcion" name='descripcion' type="text" class="form-control" placeholder="INGRESE LA DESCRIPCION" >
                  </div>
                  <div class="form-group">
                  <div class="row">
                  <div class="col-lg-6">
...
<!-- Page specific script -->
                  ...
                  <div class="col-md-2">
                  <a href="tipokardex.php" class="btn btn-danger " role="button" aria-pressed="true">Salir</a>
                  </div>
                  </div>
                  </div> 
                  </div> 
