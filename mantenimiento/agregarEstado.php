<?php
   ...
   session_start();
       /*BITACORA*/
       $consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'agregarEstado.php'";
   ...
   if(!empty($_POST)){
    ...
    if($descrip==''){
     ...
     $insert=mysqli_query($conexion,"INSERT INTO tbl_estadopedido (Descripcion) VALUES ('$descrip')");

     if($insert){

       echo '<script>
        alert(" Se agrego exitosamente. ");
        window.location="estadopedido.php";
        </script>';
     }
    }
          ...
          <div class="col-md-5">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Estados de los pedido</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
<!-- Page specific script -->
               ...
               <?php } ?>
                  ...
                  <div class="col-md-2">
                  <a href="estadopedido.php" class="btn btn-danger " role="button" aria-pressed="true">Salir</a>
                  </div>
                  </div>
                  </div> 
                  </div> 
