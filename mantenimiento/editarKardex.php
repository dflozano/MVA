<?php
   ...
   $cod = $_GET['CodigoTipoKardex'];
      /*BITACORA*/
      $consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'editarKardex.php'";
      ...
      $CodObjeto=$numero;
      $accion='Editar';
      $descrip='Se edito un tipo de kardex';
      bitacora($CodObjeto,$accion,$descrip);

   /*Obtengo valores del estado*/
   $consulta="SELECT * from tbl_tipokardex where CodigoTipoKardex = '$cod'";
   ...
   if(!empty($_POST)){
    ...
    $descrip=$_POST['descripcion'];
     ...
     $update=mysqli_query($conexion,"update tbl_tipokardex set Descripcion = '$descrip' where CodigoTipoKardex = '$cod'");
...
<!-- Page specific script -->
       ...
       <?php  if($permiso_insertar==1){?><!-- Generar insetar------------------------------------------------------------->
             ...
             <?php  if($permiso_eliminar==1){?><!--ejemplo de quitar el permiso de actualizar ------------------------------------------------------------->
