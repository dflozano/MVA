...
//BITACORA/
   $consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'editar_mantenimiento_tipopersona.php'";
   ...
   $CodObjeto=$numero;
   $accion='Ingreso';
   $descrip='Se ingreso a la pantalla para de editar tipo de persona';
...
if (isset($_GET['CodigoTipoPersona'])) {
  $codigo=$_GET['CodigoTipoPersona'];
  $consulta="SELECT * FROM tbl_tipopersona WHERE  CodigoTipoPersona= $codigo";
  ...
  if (mysqli_num_rows($conResul1)==1){// si encontramos un resultado
      ...
      $Codigoparametro=$fila['CodigoTipoPersona'];
      $tipo_p=$fila['TipoPersona'];
  }  
...
if (isset($_POST['actualizar'])){
    ...
    $actualizar="UPDATE  tbl_tipopersona set  TipoPersona='$persona' WHERE CodigoTipoPersona=$id ";
    mysqli_query($conn, $actualizar);
    echo '<script>
    alert(" Se actualizo tipo de persona");
...
<!DOCTYPE html>
 ...
 <div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content-header -->
 <!-- Main content -->              <?php  if($permiso_consultar==1){?>
          ...
          <div class="col-12">  
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"> Gestión mantenimiento de tipo de persona</h3>
              </div> 
 ...
 <div class="form-row">
    ...
    <div class="col-12 my-5">
      <div class="card-header">
                    <h5 class="card-title"> Editar Tipo de persona:</h5>
                </div>
                <form class="p-4" method="POST" action="../mantenimiento/editar_mantenimiento_tipopersona.php?CodigoTipoPersona=<?php echo $_GET['CodigoTipoPersona'];?>">
                  
                    <div class="mb-3">
                        <label class="form-label">Tipo de persona: </label>
                        <input type="text" class="form-control" name="persona" value="<?php echo $tipo_p;?>">
                    </div>
                    <div class="d-grid">
