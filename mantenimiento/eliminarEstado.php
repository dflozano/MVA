<?php
   ...
   session_start();
       /*BITACORA*/
       $consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'eliminarEstado.php'";
  ...
  if($descrip1=="PAGADO" || $descrip1=="NO PAGADO" || $descrip1=='CANCELADO'){
    echo '<script>
    alert("NO SE PUEDE ELIMINAR ESTADOS PREDETERMINADOS");
    window.location="estadopedido.php";
    </script>';
  }else{
    $consulta="DELETE FROM tbl_estadopedido WHERE CodigoEstado = $cod";
...
<?php } ?>
          ...
          <div class="mb-2 col-6 text-center ">
            <a href="estadopedido.php" class="btn btn-success"><i class =""></i>NO</a>
          </div>
          <!-- /.col -->
        </div>
