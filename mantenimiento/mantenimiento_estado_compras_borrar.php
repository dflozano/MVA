...
include 'funcionBitacora.php';
  ...
  if(isset($_POST['Aceptar'])) {
    ...
    window.location="../mantenimiento/mantenimiento_estado_compras.php";
      ...
      $query = "DELETE FROM tbl_estadocompras WHERE CodigoEstadoCompras =$codigo";
  ...
  if (isset($_GET['CodigoEstadoCompras'])) {
    ...
    //BITACORA/
$consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'mantenimiento_estado_compras_borrar.php'";
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Estado Compras</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
  ...
  <section id="content-header">
    ...
    <div class="card card-danger">
                <div class="card-header">
                  <h3 class="card-title">¿Está seguro de eliminar <?php echo $fila['Estado']; ?>?</h3>
                </div>
               <!-- /.card-header -->
                <!-- form start -->
                ...
                <div class="card-body">
                <div class="card-body">
                    <p>Descripción:<span> <?php echo $fila['Estado']; ?></span></p>
                    </div>
                    </div>
                  <!-- /.card-body -->
                  <div class="row mb-2">
