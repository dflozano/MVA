<?php
   ...
   session_start();
       /*BITACORA*/
       $consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'agregarEstadoM.php'";
   ...
   if(!empty($_POST)){
    ...
    if($descripM==''){
     ...
     $insert=mysqli_query($conexion,"INSERT INTO tbl_estadomesa (Descripcion) VALUES ('$descripM')");
     ...
     if($insert){
       ...
       $CodObjeto=$numero;
       $accion='Agregar';
       $descrip='Se agrego un estado de mesa';
          ...
          <div class="col-md-5">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Agregue un estado</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <form  action="" method="POST">
                    ...
                    <input value='' OnKeyUp="this.value=this.value.toUpperCase();" onkeypress="comprobarEspacios(); return sololetras(event);" id="descripM" name='descripM' type="text" class="form-control" placeholder="INGRESE LA DESCRIPCION" >
                  </div>
                  <div class="form-group">
                  <div class="row">
                  <div class="col-lg-6">
