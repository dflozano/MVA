...
/*BITACORA*/
$consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'eliminarKardex.php'";
...
$CodObjeto=$numero;
$accion='Eliminar';
$descrip='Se elimino un tipo de kardex';
bitacora($CodObjeto,$accion,$descrip);
   ...
   if(isset($_POST['Aceptar'])) {
    if ('Aceptar'){
      ...
      /*Obtengo nombre del tipo*/
      $consulta="SELECT * from tbl_tipokardex where CodigoTipoKardex = '$cod'";
      $valor = mysqli_query ($conexion,$consulta);
      $variable= mysqli_fetch_array ($valor);
      $descrip1=$variable['Descripcion'];
   
      if($descrip1=='ENTRADA' || $descrip1=="SALIDA"){
       echo '<script>
       alert("NO SE PUEDE ELIMINAR PREDETERMINADOS");
       window.location="tipokardex.php";
       </script>';
      }else{
         $consulta="DELETE FROM tbl_tipokardex WHERE CodigoTipoKardex = $cod";
...
<div class="register-box">
  ...
  <div class="card-header text-center">
     <strong>¿Desea eliminar el tipo<?php echo " '".$descrip1."'"?> ?</strong>
    </div>
...
<?php } ?>
          ...
          <div class="mb-2 col-6 text-center ">
            <a href="tipokardex.php" class="btn btn-success"><i class =""></i>NO</a>
          </div>
          <!-- /.col -->
        </div>
