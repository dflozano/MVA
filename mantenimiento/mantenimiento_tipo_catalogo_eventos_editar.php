...
session_start();
  ...
  $codigo=$_GET['CodigoTipoCatalogo'];

  if (isset($_GET['CodigoTipoCatalogo'])) {
    $sql="SELECT CodigoTipoCatalogo, Descripcion FROM tbl_tipocatalogoevento WHERE CodigoTipoCatalogo='$codigo'";
    $conResul1=mysqli_query($conn,$sql);
  
    if (mysqli_num_rows($conResul1)==1){
        $fila=mysqli_fetch_array($conResul1);
        $CodigoTipoCatalogo=$fila['CodigoTipoCatalogo'];
    }  
  }
  ...
  if (isset($_POST['guardar'])){
    $d=$_POST['descripcion'];
        ...
        $insert=mysqli_query($conn,"UPDATE tbl_tipocatalogoevento SET Descripcion='$d' WHERE CodigoTipoCatalogo='$codigo'");

 echo '<script>
  window.location="http:../mantenimiento/mantenimiento_tipo_catalogo_eventos.php";
  </script>';
  } 

  //BITACORA/
$consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'mantenimiento_tipo_catalogo_eventos_editar.php'";
   ...
   <div class="form-group row">
            ...
            <div class="card card-info">
             ...
             <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" OnKeyUp="this.value=this.value.toUpperCase();" onkeypress="comprobarEspacios(); return sololetras(event);" name="descripcion" value="<?php echo $fila['Descripcion']; ?>" id='descripcion' class="form-control" value="" placeholder="Ingrese una Descripción">
                    </div>
                    </div>
                    <div class="row mb-1">
          <div class="col-sm-5">
          ...
          <div class="col-sm-5">
            ...
            <a href="../mantenimiento/mantenimiento_tipo_catalogo_eventos.php" class="btn btn-block bg-danger" value="">Cancelar</a>
            </ol>
              </div>
                  </div>
                  </div>
