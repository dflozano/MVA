<?php
   ...
   session_start();
      ...
      $consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'editarEstadoP.php'";
   ...
   $consulta="SELECT * from tbl_estadopedido where CodigoEstado = '$cod'";
   ...
   if(!empty($_POST)){
    ...
    $descrip=$_POST['descripcion'];
     ...
     $update=mysqli_query($conexion,"update tbl_estadopedido set Descripcion = '$descrip' where CodigoEstado = '$cod'");
