...
session_start();
 ...
 if(isset($_POST['btn_paquete'])){
  ...
  if($total==0){
    ...
    $consulta10="SELECT CodigoUsuario from tbl_usuario where Usuario = '$usuario'";
    $parametro10 = mysqli_query ($conn,$consulta10);
    $codigo10= mysqli_fetch_array ($parametro10);

     

  //Insertamos el numero del paquete
  $insert_pedido=mysqli_query($conn,"INSERT INTO `tbl_eventos`(`CodigoUsuario`, `CodigoEstadoEvento`, `SubTotal`) VALUES ('$codigo10[0]',4,'$total')");
...
//Actualizamos paquete temporal
    ...
    $insert_detalles=mysqli_query($conn,"INSERT INTO  `tbl_detalleevento`(NumeroEvento, CantidadPersonas, Descripcion, Precio, PrecioTotal)
    SELECT NumeroEvento, CantidadPersonas, Descripcion, Precio, PrecioTotal FROM tbl_catalogotemporal");
...
$consulta2 = "SELECT * FROM tbl_catalogotemporal" ;
...
if(empty($_POST['CantidadPersonas']) AND ($filas==0)){
    echo '<script>
    ...
    <div class="card card-info">
            ...
            <div class="card-body">
              ...
              <div class="row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" onkeypress="return solonumeros(event);" vale="CantidadPersonas" name="CantidadPersonas" value="<?php if(isset($numero)) echo $numero ?>" placeholder="Ingrese el N° de Personas">
                  </div>
                </div>
                    <!-- checkbox -->
                    <div class="form-group row">
        ...
        filter: true
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <!-- checkbox -->
                    <div class="form-group">
                        <img  src="dist/img/evento1.png" height="250" width="200">
                    </div>
                    <div class="form-group">
                        <img  src="dist/img/evento2.png" height="250" width="200">
                    </div>
                    </div>
                  <div class="col-sm-6">
                    <!-- radio -->
                    <div class="form-group">
                        <img  src="dist/img/evento3.png" height="250" width="200">
                    </div>
                    <div class="form-group">
                        <img  src="dist/img/evento4.png" height="250" width="200">
                    </div>
                  </div>
                  </div>
                  </div>
 ...
 <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    <div class="btn-group">
                    <a href="../eventos/eventos_catalogotemporal1.php?CodigoTemporalCatalogo=<?php echo $mostrar['CodigoTemporalCatalogo']?>" class="btn btn-danger">
