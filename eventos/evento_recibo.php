...
/*BITACORA*/
$consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'evento_recibo.php'";
...
if($estado1==2 OR $estado1==3){
    echo '<script>
    alert("El estado del Evento debe ser Pagado");
    ...
    <body>
        ...
        <!--    <img src="../dist/img/minuta.png" alt="Logotipo"> -->
            <p class="centrado"> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <?php echo $codigo_nombre_empresa; ?> 
                ...
                <br>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Recibo
                <br>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp ________________________
                <small></small>
                <br></p>
