<?php 
  ...
  session_start();
        $CodObjeto=25;
  $accion='Insert';
  $descrip='Se registro un nuevo Evento';
  ...
  if(isset($_POST['btn_paquete'])){
    ...
    $insert_pedido=mysqli_query($conn,"INSERT INTO `tbl_catalogoeventospredeterminados`(`Descripcion`) VALUES ('PAQUETE')");
 ...
 $update=mysqli_query($conn,"UPDATE tbl_catalogotemporal SET CodigoCatalogoEvento = '$ultimo_codigo'");

    if($update){
//Actualizamos paquete temporal
   
      //Insertamos en Catalago eventos predeterminados
      $insert_detalles=mysqli_query($conn,"INSERT INTO  `tbl_detalleevento`(CodigoCatalogoEvento, CodigoTipoCatalogo, CantidadPersonas, Descripcion, Precio, PrecioTotal)
      SELECT CodigoCatalogoEvento, CodigoTipoCatalogo, CantidadPersonas, Descripcion, Precio, PrecioTotal FROM tbl_catalogotemporal");
        ...
        if(!isset($_POST['comida'])){
          ...
          if(is_array($comida)){
            foreach($comida as $comida){
              ...
              //INSERT
              $catalogo="INSERT INTO tbl_catalogotemporal(CodigoTipoCatalogo, Descripcion, CantidadPersonas, Precio, PrecioTotal) VALUES('$codigo5','$codigo4','$cantidad','$precio3','$total')";
        ...
        if(empty($_POST['golosina'])){
          ...
          if(is_array($golosina)){
            foreach($golosina as $golosina){
              ...
              //INSERT
              $catalogo="INSERT INTO tbl_catalogotemporal(CodigoTipoCatalogo, Descripcion, CantidadPersonas, Precio, PrecioTotal) VALUES('$codigo8','$codigo7','$cantidad','$precio6','$total1')";
              $resultado=mysqli_query($conn,$catalogo);
        ...
        if(empty($_POST['postres'])){
         ...
         if(is_array($postres)){
           foreach($postres as $postres){
             ...
             //INSERT
             $catalogo="INSERT INTO tbl_catalogotemporal(CodigoTipoCatalogo, Descripcion, CantidadPersonas, Precio, PrecioTotal) VALUES('$codigo11','$codigo10','$cantidad','$precio9','$total3')";
             $resultado=mysqli_query($conn,$catalogo);
           }
         }
       }
       ...
       if(empty($_POST['servicio'])){
        ...
        if(is_array($servicio)){
          foreach($servicio as $servicio){
            ...
            //INSERT
            $catalogo="INSERT INTO tbl_catalogotemporal(CodigoTipoCatalogo, Descripcion, CantidadPersonas, Precio, PrecioTotal) VALUES('$codigo14','$codigo13', '$cantidad','$precio12','$total4')";
            $resultado=mysqli_query($conn,$catalogo);
          }
        }
      }
           ...
           if(empty($_POST['topping'])){
            ...
            if(is_array($topping)){
              foreach($topping as $topping){
                ...
                //INSERT
                $catalogo="INSERT INTO tbl_catalogotemporal(CodigoTipoCatalogo,Descripcion, CantidadPersonas, Precio, PrecioTotal) VALUES(NULL,'$codigo16','$cantidad','$precio15','$total5')";
                $resultado=mysqli_query($conn,$catalogo);
              }
            }
          }
  ...
  <div class="content-wrapper">
   ...
   <div class="col-md-8">
              ...
              <div class="card-body">
                <form >
                  <div class="form-group row">
                    <label for="" class="col-sm-4 col-form-label">N° de Personas</label>
                    <div class="col-sm-6">
                  ...
                  <div class="form-group row">
                <label for="golosina" class="col-sm-3 col-form-label">Comida</label>
     ...
     // Initialize multiple select on your regular select
                    ...
                    <div class="form-group row">
                <label for="golosina" class="col-sm-3 col-form-label">Golosina</label>
     ...
     $("#golosina").multipleSelect({
        filter: true
                    ...
                    <div class="form-group row">
                <label for="postre" class="col-sm-3 col-form-label">Postre</label>
     ...
     $("#servicio").multipleSelect({
        filter: true
              ...
              <div class="form-group row">
                <label for="extra" class="col-sm-3 col-form-label">Toppings de Minutas</label>
     ...
     $("#topping").multipleSelect({
        filter: true
                  ...
                  <div class="row mb-1">
          <div class="col-sm-5">
          <ol class="float-sm-left"> <?php  if($permiso_insertar==1){?><!-- Generar insetar------------------------------------------------------------->
                       <button name='btnguardar' type="submit" class="btn btn-success">Cargar</button>
          ...
          <div class="col-sm-5">
            ...
            ?>
                ...
                <?php  if($permiso_insertar==1){?><!-- Generar insetar------------------------------------------------------------->
                                   <button type="" id='btn_paquete' name='btn_paquete' type="" class="btn btn-block btn-info md-3">Realizar</button>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    <div class="btn-group">
                    <a href="../eventos/eventos_catalogotemporal.php?CodigoTemporalCatalogo=<?php echo $mostrar['CodigoTemporalCatalogo']?>" class="btn btn-danger">
