<?php
   ...
   /*BITACORA*/
   $consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'eventos_tarjeta.php'";
   ...
   $CodObjeto=$numero;
   $accion='Escoger';
   $descrip='Decide si desea recibo';
   bitacora($CodObjeto,$accion,$descrip);

   $usuario=$_SESSION['usuario']; 
   $cod=$_GET['NumeroEvento'];

   $udpate=mysqli_query($conn,"UPDATE tbl_eventos SET CodigoEstadoEvento = 1 WHERE NumeroEvento = '$cod'");
