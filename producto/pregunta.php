...
<div class="register-box">
  ...
  <div class="card-header text-center">
     ...
     <strong>¿Desea relacionar con materia prima?</strong>
    </div>
      ...
      <div class="mb-0" class="alert"><?php echo isset($alert) ? $alert : ''; ?> </div> 
        ...
        <div class="row">
          ...
          <div class="mb-2 col-6 text-center">
            <a href="seleccionarProducto.php?Nombre=<?php echo $nombre?>" class="btn btn-primary"><i class=""></i>SI</a>
          </div>
          <div class="mb-2 col-6 text-center ">
            <a href="cata_productoRestaurante.php" class="btn btn-danger"><i class =""></i>NO</a>
          </div>
          <!-- /.col -->
        </div>
