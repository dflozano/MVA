<?php
   ...
   /*BITACORA*/
   $consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'editarTopping.php'";
   ...
   $CodObjeto=$numero;
   $accion='Ingreso';
   $descrip='Se ingreso a la pantalla de editar un topping';
   bitacora($CodObjeto,$accion,$descrip);

   $top=$_GET['CodigoToppings'];
    
    //Datos
    $consultdatos="SELECT * from tbl_toppings where CodigoToppings = '$top'";
    $datos = mysqli_query ($conexion,$consultdatos);
    ...
    if(isset($_POST['btn_editar'])){
      ...
      $nombre1=$_POST['descripcion'];
      $precio1=$_POST['precio'];

      //Autualizamos topping
      $update=mysqli_query($conexion,"update tbl_toppings set Nombre = '$nombre1', Precio = '$precio1' where CodigoToppings = '$top'");

      //Autualizamos catalogo
      $update1=mysqli_query($conexion,"update tbl_catalogomateriaprima set NombreProducto = '$nombre1' where NombreProducto = '$nombre'");
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <form  action="" method="POST">
                    ...
                    <input value='<?php echo $nombre?>' OnKeyUp="this.value=this.value.toUpperCase();" onkeypress="comprobarEspacios(); return sololetras(event);" id="descripcion" name='descripcion' type="text" class="form-control" placeholder="INGRESE LA DESCRIPCION" >
                  </div>
                  <div class="form-group">
                  <div class="row">
                  <div class="col-lg-6">
...
<!-- Page specific script -->
                  ...
                  <?php  if($permiso_actualizar==1){?><!--ejemplo de quitar el permiso de actualizar ------------------------------------------------------------->
                          <button type="" id='btn_editar' name='btn_editar' type="" class="btn btn-primary btn-block md-3">Editar</button>
        <?php } ?>
                  </div>
                  <div class="col-md-1">
                  </div>
                  <div class="col-md-2">
                  <a href="toppings.php" class="btn btn-danger " role="button" aria-pressed="true">Salir</a>
                  </div>
                  </div>
                  </div> 
                  </div> 
