<?php
   ...
   /*BITACORA*/
   $consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'agregarTopping.php'";
   ...
   $CodObjeto=$numero;
   $accion='Ingreso';
   $descrip='Se ingreso a la pantalla para agregar un nuevo Topping';
   ...
   if(!empty($_POST)){
    ...
    if(empty($_POST['descripcion'])){
      ...
      $consulta = "SELECT * FROM tbl_catalogomateriaprima WHERE NombreProducto ='$descrip' " ;
      $resultado = mysqli_query($conexion, $consulta);
      $filas=mysqli_num_rows($resultado);

      if ($filas > 0) {
        //Validar si existe en toppings
        $consulta = "SELECT * FROM tbl_toppings WHERE Nombre ='$descrip' " ;
        $resultado = mysqli_query($conexion, $consulta);
        $filas=mysqli_num_rows($resultado);
        ...
        if($filas>0){
          ...
          //Insert en tabla catalogo minutas
          $insert=mysqli_query($conexion,"INSERT INTO tbl_toppings (Nombre, Precio) VALUES ('$descrip','$precio')");
          ...
          if($insert){
            ...
            $CodObjeto=36;
            $accion='Guardar';
            $descrip='Se agrego un nuevo Topping';
            bitacora($CodObjeto,$accion,$descrip);
        ...
        echo '<script>
          alert("Debe agregarlo primero como materia prima");
          </script>';
          ...
          <div class="col-md-5">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Registro de nuevo topping</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <form  action="" method="POST">
                    ...
                    <input OnKeyUp="this.value=this.value.toUpperCase();" onkeypress="comprobarEspacios(); return sololetras(event);" id="descripcion" name='descripcion' type="text" class="form-control" placeholder="INGRESE LA DESCRIPCION" >
                  </div>
                  <div class="form-group">
                  <div class="row">
                  <div class="col-lg-6">
                  <label for="">Precio</label>
                  <input pattern="[0-9]+" onkeypress="return solonumeros(event);" id="precio" name='precio' type="text" class="form-control" placeholder="INGRESE EL PRECIO" >
                  </div>
