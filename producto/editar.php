<?php
  ...
  if(isset($_POST['btn_agregar'])){
      ...
      if($_POST['materia']=="ESCOGA UNA MATERIA PRIMA"){
        echo '<script>
      ...
      $insert_relacion=mysqli_query($conn,"INSERT INTO tbl_productomateria (CodigoProducto, CodigoMateria, Cantidad) VALUES ('$codnombre','$codmateria','$cantidad')");
      ...
      $CodObjeto=$numero;
      $accion='Agregar';
      $descrip='Agrega una relación con materia prima';
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4">
                      ...
                      <input value='1' min="" id="cantidad" name="cantidad" type="number" class="form-control" placeholder="Ingrese" required>
                    </div>
                    </div>
                          </div>
...
<!-- Page specific script -->
             ...
             <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php 
                  $con=0;
                  $consulta_tablas="SELECT a.CodigoRelacion, a.CodigoProducto, a.CodigoMateria, a.Cantidad, b.CodigoMateria, b.NombreProducto
                  FROM tbl_productomateria as a INNER JOIN tbl_catalogomateriaprima as b ON b.CodigoMateria = a.CodigoMateria  where a.CodigoProducto = '$cod'";                            
                    ...
                    <div class="btn-group">
                       <a href="eliminar.php?CodigoRelacion=<?php echo $row['CodigoRelacion']?>"  class="btn btn-danger"> 
