<?php
   ...
   /*BITACORA*/
   $consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'agregarminuta.php'";
   ...
   $CodObjeto=$numero;
   $accion='Ingreso';
   $descrip='Ingreso en la pantalla para agregar una nueva minuta al catalogo';
   bitacora($CodObjeto,$accion,$descrip);

   $catalogo=mysqli_query($conexion,"SELECT Descripcion FROM tbl_catalogominutas");
   ...
   if(!empty($_POST)){
    ...
    alert("Llene todos los campos");
      ...
      $insert=mysqli_query($conexion,"INSERT INTO tbl_catalogominutas (Descripcion, Cantidad, Precio) VALUES ('$descrip', '$cantidad','$precio')");
      ...
      if($insert){
        ...
        $CodObjeto=$numero;
        $accion='Guardar';
        $descrip='Se agrego una nueva minuta';
        bitacora($CodObjeto,$accion,$descrip);
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <label for="">Cantidad</label>
                    <input value=1 min="1" id="cantidad" name="cantidad" type="number" class="form-control" placeholder="Ingrese" required>
                  </div>
                  </div>
