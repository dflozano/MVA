...
$CodObjeto=24;
  $accion='Delete';
  $descrip='Se elimino un producto en catálago de producto Evento';
  ...
  if(isset($_POST['Aceptar'])) {
    if ('Aceptar'){
      $query = "DELETE FROM tbl_catalogoproductoeventos WHERE CodigoCatalogoProductoEvento  =$Cod";
  ...
  if (isset($_GET['CodigoCatalogoProductoEvento'])) {
    $Cod = $_GET['CodigoCatalogoProductoEvento'];
    $consulta="SELECT c.CodigoCatalogoProductoEvento, t.Descripcion, c.NombreProducto, c.PrecioTotal 
    FROM tbl_catalogoproductoeventos as c INNER JOIN tbl_tipocatalogoevento as t on c.CodigoTipoCatalogo = t.CodigoTipoCatalogo where c.CodigoCatalogoProductoEvento='$Cod'";
    $conResul=mysqli_query($conn,$consulta);
    $valores= mysqli_fetch_array ($conResul);
    $nombre=$valores['NombreProducto'];
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Catálago Producto</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
