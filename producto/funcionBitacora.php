<?php
  ...
  function bitacora($CodObjeto,$accion,$descrip){
    ...
    $consultabitacora=mysqli_query($conexion,"INSERT INTO tbl_bitacora (CodigoUsuario, CodigoObjeto, Fecha, Accion, Descripcion)
     VALUES ('$codUsuario','$CodObjeto',now(),'$accion','$descrip')");
  }
?>