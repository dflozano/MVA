...
session_start();
 ...
 /*BITACORA*/
      $consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'cataProducto_ed.php'";
      ...
      $CodObjeto=$numero;
      $accion='Actualizar';
      $descrip='Se edito información de materia prima';
      bitacora($CodObjeto,$accion,$descrip);
if (isset($_GET['CodigoMateria'])) {
  $cod=$_GET['CodigoMateria'];
  $consulta2="SELECT * from tbl_catalogomateriaprima WHERE CodigoMateria = $cod";
...
if (isset($_POST['btnguardar'])){
  ...
  if ($_POST['NombreProducto']){
      $consula=mysqli_query($conn,"UPDATE tbl_catalogomateriaprima SET NombreProducto = '$nombre', Medida = '$medida', StockMinimo = '$stock'  where CodigoMateria= '$cod' ");
    if($consula){
      ...
      window.location="cataProducto_ed.php";
      </script>';
    }
   ...
   <div class="col-md-9">
            ...
            <div class="card card-info">
              ...
              <div class="card-header text-center">
                <h3 class="card-title">Edite la materia prima</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <div class="card-body">
                <form >
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input onkeypress="comprobarEspacios(); return sololetras(event);" maxlength="50" minlength="10" OnKeyUp="this.value=this.value.toUpperCase();"  type="text" class="form-control" id="NombreProducto" name="NombreProducto" value="<?php echo $fila['NombreProducto']; ?>" placeholder="Update"> 
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="" class="col-sm-4 col-form-label">Medida</label>
                    <div class="col-sm-7">
                      <input onkeypress="comprobarEspacios(); return sololetras(event);" maxlength="50" minlength="10" OnKeyUp="this.value=this.value.toUpperCase();" value="<?php echo $fila['Medida'];  ?>" type="text" name="Medida" id="Medida" class="form-control" placeholder="Medida de la materia prima" >
          </div>
            ...
            <div class="col-sm-3">
             <input onkeypress="return solonumeros(event);" value="<?php echo $fila['StockMinimo']; ?>" min="1" id="stock" name="stock" type="number" class="form-control" placeholder="Ingrese" required>
            </div>
          </div>
                  <div class="row mb-2">
          <div class="col-sm-6">
