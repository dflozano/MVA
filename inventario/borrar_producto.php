<?php
 ...
 session_start();
    $consulta="SELECT CodigoObjeto from tbl_objetos where Objeto = 'borrar_producto.php'";
    ...
    $CodObjeto=$numero;
    $accion='Eliminar';
    $descrip='Se elimino materia prima ';
 ...
 $conResul1=mysqli_query($conn,$consulta2);
  ...
  if(isset($_POST['aceptar'])) {
    ...
    $consulta3="DELETE FROM tbl_inventarioexistente WHERE CodigoMateriaPrima = $cod";
    $conResul3=mysqli_query($conn,$consulta3);

    $consulta="DELETE FROM tbl_catalogomateriaprima WHERE CodigoMateria = $cod";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Catalago de Producto</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="container-fluid">
  ...
  <div class="card card-info">
             ...
             <!-- /.card-header -->
              ...
              <div class="card-body">
                  <p>Nombre del Producto: <span> <?php echo $fila['NombreProducto']; ?></span></p>
                  </div>
                <!-- /.card-body -->
                <div class="row mb-2">
          <div class="col-sm-6">
